...
public class CardsListener2 implements CardStack.CardEventListener {
    ...
    public CardsListener2(){
        super();
    }

    public CardsListener2(Context mContext, List<SwypeImage> imageList, CardStack cardStack) {
        super();
    ...
    public void discarded(int id, int direction) {
        ...
        userPattern.put(id, direction == 0 || direction == 1);
